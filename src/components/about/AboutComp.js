        ...
        <Row className="about-comp-content comp-margin-top">
          ...
          <div className="about-us-content">
            ...
            <p data-aos="fade-up" className="about-us-text-item">We as the creators of the “Space Turtles NFT” aims to illustrate the idea
              ...
              yourself
              on the path to realizing that dream, no matter what your pace is, you can be as slow as a turtle, and what
              obstacles you face they can be as high as the sky, if you stay loyal to your dream and consistent with
              your
              effort you will overcome everything and eventually realize your dreams. We as the creator of the “Space
            ...
            <p data-aos="fade-up" className="about-us-text-item">We have used all national flags to portray that no matter where you come
              ...
              sun
              and they represent the dawn of a new beginning. We as creators intend to invigorate the community and
            ...
            <p data-aos="fade-up" className="about-us-text-item">Me and some of our team members have quit their jobs because we wanted to
              ...
              in
              so much hard work, research, effort, and utilizing connections with people who have an immense impact in
              the
              NFT industry to promote the project, we as the creators of “Space Turtles NFT” are 100% sure that this
              project will be the next big thing in the world of NFT's. So welcome to our special community where not
              only
              will you enjoy the art, get into a great community but also see how the demand after your bellowed art
              will
              rise which means that while you are enjoying yourself, your artwork is going up in value. In the future,
              we
              will have brief interviews with different podcasts regarding our art and the creators behind it. But for
              now, just enjoy your stay in our welcoming community and get ready for the next big hit in the NFT world.
