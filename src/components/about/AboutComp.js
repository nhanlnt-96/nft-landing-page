                ...
                <Col lg={9} md={9} sm={12}
                    ...
                    <div className="right-side-container">
                        ...
                        <div className="about-subtitle">
                            ...
                            <p className="about-subtitle-item">Me and some of our team members have quit their jobs because
                                ...
                                project will be the
                                next big thing in the world of NFT's.
                            </p>

                            <p className="about-subtitle-item">So welcome to our special community where not only will you
